	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			if (cart_list == null) {
				...
				//out.println("session created and added list");
			} else {
//				out.println("cart list exist");
				...
				for (Cart c : cart_list) {
					if (c.getId() == id) {
						...
						System.out.println("<h3 style='color:crimson; text-align:center'>Item already exist in Cart<a href='cart.jsp'>Go to Cart</a></h3>");
